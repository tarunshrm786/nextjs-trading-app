...
// import { FaChartLine, FaBitcoin, FaDollarSign } from 'react-icons/fa';
...
//             <button onClick={handlePrev} className={styles.sliderButton}>Prev</button>
//             <button onClick={handleNext} className={styles.sliderButton}>Next</button>
//           </div>
//         </div>
//       </div>
//     </section>
